          ...
          @can('archivos.create')
                ...
                onsubmit="return confirm('¿Está seguro de agregar el archivo')" style="display: inline-block;" enctype="multipart/form-data">
                 ...
                 <label class="block text-sm">
                        <span class="text-gray-700 dark:text-gray-200">Selecciona archivo a cargar</span>
                        <br>
                        <input type="file" name="archivo" id="archivo" class="text-gray-700 dark:text-gray-200">
                    </label>
                    <br>
                    <br>
                     <div>
                      <input class="bg-purple-600 text-white px-4 py-2 border rounded-md hover:bg-green-600 hover:border-purple-600 hover:text-black " type="submit" value="Cargar" onclick="myFunction()">
                     </div>
                    </label>
                    @endcan
                 </div>
            ...
            <!--OTRO !-->
            <div class="w-96 mb-8 overflow-hidden rounded-lg shadow-xs">
              <div class="w-96 overflow-x-auto">
                <table class="w-11/12 ml-12">
                  <thead>
                  <br>
                 <br>
