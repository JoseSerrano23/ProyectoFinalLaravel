...
<main class="h-full pb-16 overflow-y-auto">
          <div class="container grid px-6 mx-auto">
              ...
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                  ...
                  <td class="px-4 py-3 text-sm">
                    <a href="{{ route('users.show', $user) }}" class="text-sm dark:text-white hover:underline" value="{{old('titulo')}}">
                    {{ $user->name }}
                    </a>
                    @error('name')
              <br>
            ...
            <span class="px-2 py-1 font-semibold leading-tight text-black bg-blue-400 rounded-full dark:bg-blue-700 dark:text-white" value="{{old('descripcion')}}">
            {{ $user->email }}
            </span>
            @error('email')
              <br>
