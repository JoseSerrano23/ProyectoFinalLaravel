...
<aside
  ...
  <li class="relative">
        ...
        <main class="h-full pb-16 overflow-y-auto">
          ...
          <td class="px-4 py-3">
          <p class="font-semibold">{{ $users->id }}</p>
          </td>
          <td class="px-4 py-3">
          <p class="font-semibold">{{ $users->name }}</p>
          </td>
          <td class="px-4 py-3">
          <p class="font-semibold">{{ $users->email }}</p>
          </td>
          </tr>
          </tbody>
                 </table>
    ...
    @method('DELETE')
    <br>
    <input class="bg-purple-700 text-white px-4 py-2 border rounded-md hover:bg-purple-700 hover:text-black " type="submit" value="Eliminar Usuario">
    </form>
    <br>
    <br>
                </div>
