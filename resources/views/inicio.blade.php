            ...
            <li class="relative px-6 py-3">
              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  ...
                  class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                >
                  <a class="w-full" href="{{ url('/contacto') }}">
                    Contacto
                  </a>
                </li>
                </ul>
  ...
  <li class="relative">
        ...
        <main class="h-full pb-16 overflow-y-auto">
          ...
          <div class="container px-6 mx-auto grid">
            <h2 class="my-6 text-5xl font-semibold text-gray-700 dark:text-gray-200 text-center"> Bienvenidos a Farmacia PAOKI </h2>
              <!--Carrousel Slider !-->
...
<div class="p-20">
  <div class="bg-blue-500 dark:bg-blue-500 p-6 rounded-lg shadow-lg">
    <h2 class="text-2xl font-bold mb-2 text-gray-100 dark:text-gray-200">FARMACIA PAOKI</h2>
...
<div class="text-gray-700 dark:text-gray-200 flex justify-center font-normal m-0.5 sm:text-4x1 md:text-4x1 lg:text-4xl x1:text-5x1 2x1:text-7x1">
  <p class="m-20 mt-0 mb-0 text-lg p-8 text-center">
    ...
    farmaceutica@farmaciapaoki.com <br>
